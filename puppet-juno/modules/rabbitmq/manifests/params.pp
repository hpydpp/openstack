...
class rabbitmq::params {
  ...
  case $::osfamily {
    ...
    'RedHat', 'SUSE': {
      ...
      #$packaoe_source   = "ftp://pxe3/rabbitmq-server-${version}.el7.noarch.rpm"
      $package_source   = ''
      #$packaoe_source  = "ftp://pxe3/rabbitmq-server-${version}.noarch.rpm"
    }
    default: {
  ...
  $package_apt_pin            = ''
  $package_gpg_key            = 'ftp://pxe3/rabbitmq-signing-key-public.asc'
